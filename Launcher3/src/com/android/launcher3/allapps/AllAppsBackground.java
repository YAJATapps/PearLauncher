...
public class AllAppsBackground extends View {
    ...
    public AllAppsBackground(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        int scrimColor = ContextCompat.getColor(context, R.color.all_apps_statusbar_color_light);
        ...
        mBlurDrawable = Launcher.getLauncher(context).getBlurWallpaperProvider().createDrawable();
